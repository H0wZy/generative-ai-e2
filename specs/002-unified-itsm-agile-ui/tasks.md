...
- [ ] T037a [US3] Povoar o board FRESH no Jira **antes da apresentação**: estimar issues em `customfield_10016`, vincular a épicos, escrever objetivo do sprint, fechar ao menos 2 sprints para a velocidade ter série, e definir `max` numa coluna para exercitar FR-028. Hoje o sprint tem 1 issue, 0 pontos, nenhum épico e nenhum sprint fechado — o dashboard renderiza quase vazio. Trabalho de dado, não de código
